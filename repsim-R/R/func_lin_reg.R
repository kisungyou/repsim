...
#'
#' Compute pairwise linear–regression fit between multiple representations. 
#' For each pair, a least–squares map is used to assess how well one representation predicts the other, and the result is
#' symmetrized.
#' 
...
#' 
#' @references 
#' \insertRef{romero_2014_FitNetsHintsThin}{repsim}
#' 
#' @export
lin_reg <- function(mats){
  # check the input
  aux_checker(mats, "lin_reg")
  
  # pass onto C++ part and return
  return(cpp_LinReg(mats))
}
